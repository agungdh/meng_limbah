...
class M_neraca extends CI_Model{	
	...
	function ambil_jumlah_masuk_dari_limbah_lalu($id_unit, $id_limbah, $bulan_awal, $tahun){
		$sql = "SELECT sum(jumlah) total
				FROM masuk m, sub_limbah sl, limbah l, sumber s
				WHERE m.id_unit = ?
				AND l.id = ?
	...
	function ambil_jumlah_masuk_dari_limbah_lalu_semuasemua($id_limbah, $bulan_awal, $tahun){
		$sql = "SELECT sum(jumlah) total
				FROM masuk m, sub_limbah sl, limbah l, sumber s
				WHERE l.id = ?
				AND m.id_sub_limbah = sl.id
	...
	function ambil_jumlah_keluar_dari_limbah_lalu($id_unit, $id_limbah, $bulan_awal, $tahun){
		$sql = "SELECT sum(jumlah) total
				FROM keluar
				WHERE id_unit = ?
				AND id_limbah = ?
	...
	function ambil_jumlah_keluar_dari_limbah_lalu_semuasemua($id_limbah, $bulan_awal, $tahun){
		$sql = "SELECT sum(jumlah) total
				FROM keluar
				WHERE id_limbah = ?
				AND month(tanggal) < ?
