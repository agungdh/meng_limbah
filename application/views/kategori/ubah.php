  ...
  <form name="form" id="form" role="form" method="post" action="<?php echo base_url('universal/' . "aksi_ubah/" . $modul); ?>">
    ...
    <div class="form-group">
      <label for="kategori">Kategori</label>
          <input value="<?php echo $data[$modul]->kategori; ?>" required type="number" class="form-control" id="kategori" placeholder="Isi Kategori" name="data[kategori]">          
    </div>

    <div class="form-group">
      <label for="masa_berlaku_hari">Masa Penyimpanan Maksimal (Hari)</label>
          <input value="<?php echo $data[$modul]->masa_berlaku_hari; ?>" required type="number" class="form-control" id="masa_berlaku_hari" placeholder="Isi Masa Penyimpanan Maksimal (Hari)" name="data[masa_berlaku_hari]">          
    </div>
