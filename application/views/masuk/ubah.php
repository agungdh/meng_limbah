<div class="box box-primary">
  <div class="box-header with-border">
    <h4><strong><font color=blue>UBAH LIMBAH MASUK</font></strong></h4>
  </div><!-- /.box-header -->
  ...
  <form name="form" id="form" role="form" method="post" action="<?php echo base_url('masuk/aksi_ubah'); ?>" enctype="multipart/form-data">
    ...
    <div class="form-group">
      <label for="foto">Foto</label>
          <br>
          <img src="<?php echo file_exists('uploads/masuk/' . $data['masuk']->id) ? base_url('uploads/masuk/' . $data['masuk']->id) : base_url('assets/no-images.jpg'); ?>" height="150" width="150">
