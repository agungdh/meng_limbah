    ...
    <table id="lookup" class="table table-striped table-bordered table-hover" cellspacing="0" width="100%">
      ...
      <tbody>
        ...
        foreach ($data['limbah'] as $item) {
          ...
          $lalu1 = $this->m_neraca->ambil_jumlah_masuk_dari_limbah_lalu_semuasemua($item->id, $tanggal)->total != null ? $this->m_neraca->ambil_jumlah_masuk_dari_limbah_lalu_semuasemua($item->id, $tanggal)->total : 0;
          $lalu2 = $this->m_neraca->ambil_jumlah_keluar_dari_limbah_lalu_semuasemua($item->id, $tanggal)->total != null ? $this->m_neraca->ambil_jumlah_keluar_dari_limbah_lalu_semuasemua($item->id, $tanggal)->total : 0;
          $lalu = $lalu1 - $lalu2;
          $masuk = $this->m_neraca->ambil_jumlah_masuk_dari_limbah_semuasemua($item->id, $data['bulan'], $data['tahun'])->total != null ? $this->m_neraca->ambil_jumlah_masuk_dari_limbah_semuasemua($item->id, $data['bulan'], $data['tahun'])->total : 0;
          $keluar = $this->m_neraca->ambil_jumlah_keluar_dari_limbah_semuasemua($item->id, $data['bulan'], $data['tahun'])->total != null ? $this->m_neraca->ambil_jumlah_keluar_dari_limbah_semuasemua($item->id, $data['bulan'], $data['tahun'])->total : 0;
