...
<div class="box box-primary">
  <div class="box-header with-border">
    <div class="form-group">
      ...
      <a href='<?php echo base_url("neraca/export?triwulan=" . $data['triwulan'] . '&tahun=' . $data['tahun']); ?>'><button class="btn btn-primary"><i class="fa fa-upload"></i> Export Neraca</button></a>
    </div>
  </div><!-- /.box-header -->
